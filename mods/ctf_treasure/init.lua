...
treasurer.register_treasure("grenades:grenade_regular",0.08,2,1)
treasurer.register_treasure("grenades:grenade_smoke",0.08,2,1)
treasurer.register_treasure("grenades:grenade_flashbang",0.08,2,1)
