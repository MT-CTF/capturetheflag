...
local function book_on_use(itemstack, user)
	...
	core.show_formspec(player_name, "default:book", formspec_size .. formspec)
...
core.register_on_player_receive_fields(function(player, formname, fields)
	...
	if stack:get_name() ~= "default:book" and not written then
		...
		core.chat_send_player(player_name, S("The book you were writing to mysteriously disappeared."))
		return
	end
