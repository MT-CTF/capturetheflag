...
function ctf_treasure.get_default_treasures()
	return {
		...
		{"grenades:frag", 0.1, 2, 1},
		{"grenades:smoke",   0.2, 2, 1},
		-- {"grenades:flashbang",0.1,2,1},
	}
end
