...
ctf_modebase.register_mode("shooters", {
	hp_regen = 3,
	treasures = {
		...
		["ctf_ranged:ammo"     ] = {min_count = 3, max_count = 10, rarity = 0.7  , max_stacks = 2},
		["ctf_healing:medkit"  ] = {                               rarity = 0.1  , max_stacks = 2},
		["ctf_healing:bandage" ] = {                               rarity = 0.06 , max_stacks = 2},

		["grenades:smoke"] = {rarity = 0.2, max_stacks = 4},
	},
	crafts = {
		"ctf_ranged:ammo",
	    "default:axe_iron",
	...
	is_bound_item = function(_, name)
		if name:match("ctf_mode_shooter:") then
			return true
		end
	end,
