...
If you are creating the PR yourself, it is always better to make each PR on a different branch of your fork of the repo. For example if you want to add a map or make an enhancement, then make a separate branch for it, and so on. This will obviate and possible conflicts with any of your already open PRs.  
