...
function ctf_match.next()
	...
	minetest.chat_send_all(minetest.colorize("#9811ff", "Next round!"))
...
function ctf_match.check_for_winner()
	...
	if not game_won then
		...
		minetest.chat_send_all(minetest.colorize("#1164ff", ("Team " .. winner .. " won!")))
...
ctf_flag.register_on_capture(function(attname, flag)
	...
	if fl_team and #fl_team.flags == 0 then
		...
		minetest.chat_send_all(minetest.colorize("#9811ff", (flag.team .. " has been defeated!")))
	end
