...
for _, team in ipairs(ctf_teams.teamlist) do
    ...
    function def.on_rightclick(pos, node, player)
        ...
        local formspec = table.concat({
            "size[12,12]",  -- Modifié de 10,12 à 12,12
            default.get_hotbar_bg(2, 7.85),
            "list[current_player;main;2,7.85;8,1;]",
            "list[current_player;main;2,9.08;8,3;8]",
        }, "")
        ...
        formspec = formspec .. "list[" .. chestinv .. ";main;0,0.3;8,7;]" ..
            "background[8,-0.2;4.15,7.7;ctf_map_pro_section.png;false]"

        if pro_access == true then
            formspec = formspec .. "list[" .. chestinv .. ";pro;8,0.3;4,7;]" ..
                "listring[" .. chestinv .. ";pro]" ..
                "listring[" .. chestinv .. ";helper]" ..
                "label[9,-0.2;" ..
                minetest.formspec_escape("Pro players only") .. "]"
        else
            formspec = formspec .. "label[8.5,2;" ..
                minetest.formspec_escape(minetest.wrap_text(
