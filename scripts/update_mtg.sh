...
MOD_PREFIX=mtg_
MODS_TO_KEEP=(beds binoculars bucket butterflies creative default doors dye fire fireflies flowers map player_api screwdriver sfinv spawn stairs tnt vessels walls wool xpanes)
